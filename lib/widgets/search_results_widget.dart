              ...
              return Expanded(
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (spots_rem != 0 &&
                          (recommendInterest
                                  .contains(documentSnapshot['cause']) ||
                              recommendSkills
                                  .contains(documentSnapshot['cause'])) &&
                          !upcomingEvents
                ...
                return Expanded(
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        if (widget.category == 'startTime') {
                          //print(1);
                          if (documentSnapshot[widget.category!].toDate().day ==
                                  widget.searchDate?.day &&
                              documentSnapshot[widget.category!]
                                      .toDate()
                                      .month ==
                                  widget.searchDate?.month &&
                              documentSnapshot[widget.category!]
                                      .toDate()
                                      .year ==
                                  widget.searchDate?.year) {
                            return EventCard(
                                documentSnapshot: documentSnapshot,
                                user: "volunteer");
                          } else {
                          ...
                          return EventCard(
                              documentSnapshot: documentSnapshot,
                              user: "volunteer");
                        } else if (documentSnapshot[widget.category!]
                            .toString()
                            .toLowerCase()
                            .startsWith(textarea_value.toLowerCase())) {
                          return EventCard(
                            documentSnapshot: documentSnapshot,
                            user: 'volunteer',
                          );
