...
class OrganisationEventDetailsPage extends StatefulWidget {
  ...
  final String user;
  const OrganisationEventDetailsPage(
      {super.key, required this.documentSnapshot, required this.user});

  @override
  State<OrganisationEventDetailsPage> createState() =>
      _OrganisationEventDetailsPageState();
}

class _OrganisationEventDetailsPageState
    extends State<OrganisationEventDetailsPage> {
  bool isFollow = false;
