                ...
                itemBuilder: (BuildContext context, int index) {
                  if(type == 'interests'){
                    return  Padding(
                      ...
                      child: Container(height: height*0.13, width: width*0.237, child: InterestCard(text: cardList[index].text, icon: cardList[index].icon, size: cardList[index].size, list: const [],),),
                    );
                  }
                  else if(type == 'skills'){
                    return  Padding(
